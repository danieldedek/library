...
class AllBooksSearch extends DatabaseHandler {

    protected function getAllBooks($book, $ISBN, $incrementalNumber, $UDC) {
        ...
        AND copy.ISBN LIKE "' . $ISBN . '%"
        AND copy.incremental_number LIKE "' . $incrementalNumber . '%"
        AND udc.name LIKE "%' . $UDC . '%";');
        ...
        echo('<table>');
        echo('<tr><th>Jméno autora</th><th>Název knihy</a></th><th>ISBN</a></th><th>Přírůstkové číslo</a></th><th>MDT</a></th><th>Zapůjčeno</th></tr>');
    ...
    protected function getAllBooksHelp($book, $ISBN, $incrementalNumber, $UDC) {
