...
class AllPublicationPlacesSearch extends DatabaseHandler {

    protected function getAllPublicationPlaces($publicationPlace) {

        $stmt = $this->connect()->prepare('SELECT id_publication_place, name FROM publication_place WHERE name LIKE "%' . $publicationPlace . '%";');
        ...
        echo("<table>");
        echo('<tr><th>Místo vydání</th><th></th></tr>');
    ...
    protected function getAllPublicationPlacesHelp($publicationPlace) {
